...
// The branded 404 body, shared by the storefront boundary (which is wrapped in
// the public shell by its group layout) and the root boundary for unmatched
// URLs (which supplies its own shell).
      ...
      <div className="mx-auto w-full max-w-6xl">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mx-auto mt-7 max-w-2xl text-sm leading-8 text-stone-400 sm:text-base">
            The page you were looking for is not available. You can return
            home or continue browsing the current collection.
          </p>
        </div>
