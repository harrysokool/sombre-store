...
function getSubtotal(items: CartItem[]) {
    return items.reduce(
        (total, item) => total + getLineTotal(item.price, item.quantity),
        0,
    );
}
                ...
                <div className="max-w-2xl space-y-5">
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-base leading-8 text-stone-400">
                            A quiet review of the items currently saved in your
                            cart.
                        </p>
                    </div>
                </div>
                ...
                {cartItems.length > 0 ? (
                    ...
                    <div className="rounded-3xl border border-white/10 bg-white/[0.02] px-6 py-16 text-center">
                        ...
                        <p className="mx-auto mt-3 max-w-xl text-sm leading-6 text-stone-400">
                            Add a product from the catalog and it will appear
                            here automatically.
                        </p>
                    </div>
                )}
